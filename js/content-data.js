...
window.SBE_CONTENT = [
  {
    ...
    tipo: "Artículo",
    nivel: "free",
    titulo: "Fundamentos de la Seguridad Basada en el Comportamiento (SBC)",
    resumen:
      "Qué es la SBC, de dónde viene y por qué observar conductas cambia los resultados de seguridad más que solo medir incidentes.",
    cuerpo: `
      <p>La Seguridad Basada en el Comportamiento (SBC) parte de una idea simple: la mayoría de los accidentes laborales no ocurren por falta de procedimientos, sino por la brecha entre lo que las personas saben y lo que realmente hacen bajo presión, cansancio o costumbre.</p>
      <p>Un programa de SBC típico se apoya en tres pilares: observación entre pares, retroalimentación inmediata y no punitiva, y datos que permiten ver patrones antes de que se conviertan en incidentes. No reemplaza la gestión de riesgos tradicional; la complementa, poniendo el foco en el comportamiento observable en terreno.</p>
  ...
  },
  {
    ...
    cuerpo: `
      ...
      <p>El error más común de un líder nuevo en SBC es convertir la observación en una inspección disfrazada. La diferencia se nota en el tono: preguntar "¿qué te llevó a hacerlo así?" en vez de "¿por qué no usaste el procedimiento?".</p>
  ...
  },
  {
    ...
    cuerpo: `
      <p>Curso estructurado en cinco módulos: fundamentos de SBC, diseño de un programa de observación, conversaciones de retroalimentación, análisis de datos conductuales y sostenibilidad del programa en el tiempo.</p>
